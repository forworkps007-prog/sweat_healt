...
function testData() {
    ...
    setTimeout(() => {
        ...
        if (hydration < 70) {
            speak('วิเคราะห์เสร็จแล้วครับ คุณเริ่มมีภาวะขาดน้ำ ระดับน้ำอยู่ที่${hydration} เปอร์เซ็นต์โปรดดื่มน้ำทันทีครับ');
        } else if (glucose > 110)
            {
            speak('วิเคราะห์เสร็จแล้วครับ ระดับน้ำตาลในเหงื่อค่อนข้างสูง  อยู่ที่ ${glucose} มิลลิกรัมต่อเดซิลิตรครับ');
        } else {
